...
#define dribPWM 4
	...
	#define FL_threshold 299
	#define FR_threshold 190
	#define LI_threshold 348
	#define LM_threshold 107
	#define LO_threshold 101
	#define RI_threshold 783
	#define RM_threshold 70
	#define RO_threshold 110
	#define BIL_threshold 191
	#define BIR_threshold 993
	#define BOL_threshold 78
	#define BOR_threshold 101	
...
int lightcnt=0, light_mult = 2;
//Cmps
int corrCmps = 0, angleCmps=0, flag = 0, receive;
unsigned int angle16;
unsigned char hbyte, lbyte;
//Ultra
int frontUltra, rightUltra, leftUltra, backUltra, tfrontUltra, trightUltra, tleftUltra, tbackUltra, currUltra, thresholdUltra = 25;
// Camera (ancient)
