...
void loop() {
    ...
    Serial.print("FO "); Serial.print(LO);
    Serial.print("RI "); Serial.print(RI);
    Serial.print("RM "); Serial.print(RM);
    Serial.print("RO "); Serial.print(RO);
    Serial.print("BIL "); Serial.print(BIL);
    Serial.print("BIR "); Serial.print(BIR);
    Serial.print("BOL "); Serial.print(BOL);
    Serial.print("BOR "); Serial.print(BOR);
    Serial.println();
	Serial.print("Front: ");
