...
robotMask = cv2.circle(robotMask,(400,304),280,255,-1)
robotMask=cv2.circle(robotMask,(400,304),130,(0),-1)

blueGoalMaskBlue = np.full((y,x), 0, dtype=np.uint8)
blueGoalMask1 = np.full((y,x), 0, dtype=np.uint8)
blueGoalMask1 = cv2.circle(blueGoalMask1,(400,304),280,255,-1)
pts = np.array([[x,y],[x,0],[450,200],[450,408]], np.int32).reshape((-1,1,2))
cv2.fillPoly(blueGoalMaskBlue,[pts],255)
blueGoalMaskBlue = cv2.bitwise_and(blueGoalMaskBlue, blueGoalMask1)
blueGoalMaskBlue = cv2.circle(blueGoalMaskBlue,(400,304),130,(0),-1)
#cv2.imshow("mask",blueGoalMask)

blueGoalMaskYellow = np.full((y,x), 0, dtype=np.uint8)
blueGoalMask1 = np.full((y,x), 0, dtype=np.uint8)
blueGoalMask1 = cv2.circle(blueGoalMask1,(400,304),280,255,-1)
pts = np.array([[0,y],[0,0],[350,200],[350,408]], np.int32).reshape((-1,1,2))
cv2.fillPoly(blueGoalMaskYellow,[pts],255)
blueGoalMaskYellow = cv2.bitwise_and(blueGoalMaskYellow, blueGoalMask1)
blueGoalMaskYellow = cv2.circle(blueGoalMaskYellow,(400,304),130,(0),-1)
