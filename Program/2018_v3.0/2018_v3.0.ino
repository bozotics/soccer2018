...
blueTopx, blueTopy, blueBotx, blueBoty, angle, break1, side, tdist, 
dist, angleBall, angleMove, distBall, centerx, centery, angleGoal,
distGoal; //side==1 is start at blue side, side==2 is start at yellow side. 
