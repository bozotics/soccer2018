...
void trackAngle(){
	...
	if (angleBall<101&&angleBall>=0){
		if(distBall>130) angleMove = angleBall*(1+(powf(100, 2)/powf(distBall, 2)));
		else angleMove = angleBall*1.4+(130 - distBall)*0.4;
	}
	else if(angleBall>-100 && angleBall<0){
		if(distBall>110) angleMove = angleBall*(1+(powf(100, 2)/powf(distBall, 2)));
		else angleMove = angleBall*1.4+(110 - distBall)*0.4;
	}
	else if (angleBall>100){
		if(distBall>120) angleMove = angleBall + (90*sqrtf(powf(90, 2)/powf(distBall, 2)));
		else angleMove = angleBall + 45 + (120 - distBall)/35*45;
	}
